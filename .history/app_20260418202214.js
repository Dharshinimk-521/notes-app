...
//stuff when u click works
document.getElementById("newPageBtn").onClick = createPage;
document.getElementById("editorArea").addEventListener("input",saveCurrPage);
document.getElementById("pageTitle").addEventListener("input",saveCurrPage);